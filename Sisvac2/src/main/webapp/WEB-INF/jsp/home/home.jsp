...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link" href="<c:url value="home/listar"/>">
					<i class="fas fa-fw fa-chart-area"></i> <span>Lista de
						pacientes</span>
			</a></li>
						...
						<div class="col-12">
							...
							<div class="card shadow mb-4 card-novaaposta mx-auto">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary text-center">Vacinar
										Paciente</h6>
								</div>
								<div class="card-body text-center">
									<div class="col-12 input-group text-center">
										<img src="img/index.jpg" class="rounded mx-auto d-block img-fluid" />
									</div>
								</div>
							</div>
						</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary" href="<c:url value="home/sair"/>">sair</a>
				</div>
			</div>
		</div>
	</div>
