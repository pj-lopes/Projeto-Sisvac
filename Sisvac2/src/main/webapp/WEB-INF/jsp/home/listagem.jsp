					...
					<div class="col-12">
						...
						<div class="card shadow mb-4 mx-auto">
							...
							<div class="card-body row">
								<div class="col input-groupmb-3d">
										...
										<tbody>
											<c:forEach items="${pacienteList}" var="paciente">
												<tr>
													...
													<td>
														<form action="<c:url value="vacinar"/>" method="post">
															<input type="hidden" name="_method" value="DELETE">
															<input type="hidden" name="paciente.id"
																value="${paciente.id}"> <input type="submit"
																class="btn btn-success" value="Vacinar">
														</form>
													</td>
												</tr>
											</c:forEach>
									...
									<c:if test="${not empty mensagem}">
										<span class="badge badge-success">${mensagem}</span>
									</c:if>
								</div>
								<div class="col-3">
									<table class="table table-hover table-bordered">
										<thead>
											<tr class="bg-primary">
												<th class="text-white">Incio da Vacinação</th>
												<th class="text-white tex-center">Categorias</th>
											</tr>
										</thead>
										<tbody>
											<tr>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary" href="<c:url value="sair"/>">sair</a>
				</div>
			</div>
		</div>
	</div>
